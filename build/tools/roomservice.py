...
custom_local_manifest = ".repo/local_manifests/styx.xml"
custom_default_revision = "p"
custom_dependencies = "styx.dependencies"
org_manifest = "StyxProject-Devices"  # leave empty if org is provided in manifest
org_display = "StyxProject-Devices"  # needed for displaying

...
ifeq ($(TARGET_BUILD_VARIANT),OFFICIAL)
    PROD_VERSION += styxOS-$(PLATFORM_STYX_VERSION)-$(TARGET_PRODUCT)-OFFICIAL.$(BUILD_NUMBER)
else
    PROD_VERSION += styxOS-$(PLATFORM_STYX_VERSION)-$(TARGET_PRODUCT)-UNOFFICIAL.$(BUILD_NUMBER)
endif
